...
openflow/udatapath/ofdatapath punix:/tmp/zyxel_1.sock -d 5067f0ec6140 -n zyxel -a 10.0.3.1:80  -i eth1,eth2 --no-local-port --log-file=./of_agent_zyxel.log &
sleep 2

# Arguments
# tcp - address of OpenFlow controller

ofprotocol unix:/tmp/zyxel_1.sock tcp:10.0.1.100 &
