...
udatapath_ofdatapath_SOURCES = \
	...
	udatapath/intune.c \
	udatapath/intune.h \
	udatapath/milegate.c \
	udatapath/milegate.h \
    udatapath/zyxel.c \
	udatapath/zyxel.h

udatapath_ofdatapath_LDADD = lib/libopenflow.a lib/libcurl.so lib/libtelnet.so lib/libxml2.so $(SSL_LIBS) $(FAULT_LIBS)
