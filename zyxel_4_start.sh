...
openflow/udatapath/ofdatapath punix:/tmp/dp3.sock -d c0e0df866a00 -n zyxel -a 192.168.12.22:8080  -i eth1,eth2 --no-local-port --log-file=./of_agent_zyxel.log &
sleep 2

# Arguments
# tcp - address of OpenFlow controller

ofprotocol unix:/tmp/dp3.sock tcp:10.0.1.100 &
